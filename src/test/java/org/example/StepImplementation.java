...
public class StepImplementation extends BaseTest {
    ...
    @Step("<xpath> xpath'li elemente <text> text degerini gonder") //ben ekledim
    ...
    @Step("<key> xpath'li element <keyword> text değerini içerdiğini kontrol et") //ben ekledim
    public void textControlByxpath(String key,String keyword) {
        assertTrue(appiumDriver.findElement(By.xpath(key)).getText().contains(keyword),"elementi içermiyor");
        logger.info("Elementi içeriyor");
    }
